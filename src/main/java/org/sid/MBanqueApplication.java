...
public class MBanqueApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		  ...
		  Client c1 = clientRepository.save(new Client("sinami", "sinami@gmail.com"));
		  Client c2 = clientRepository.save(new Client("zoldyk", "zoldyk@gmail.com"));
		  ...
		  Date(), 6000, c1, 5.5)); operationRepository.save(new Versement(new Date(),
		  6000, cp1)); operationRepository.save(new Versement(new Date(), 2300, cp1));
